...
{
    public partial class V013ServisHakedi
    {
        ...
        public DateTime Htarih { get; set; }
        public DateTime? Fattar { get; set; }
        public string Fatno { get; set; }
        public byte? Hstatus { get; set; }
        public string Hinsuser { get; set; }
        public DateTime? Hinsdate { get; set; }
        public string Hupduser { get; set; }
        public DateTime? Hupddate { get; set; }
        public int Hlogref { get; set; }
        public double? Htutar { get; set; }
        public string Odemedurumu { get; set; }
        public string Hno { get; set; }
        public int Servisref { get; set; }
        public bool? Hmailgittimi { get; set; }
        public DateTime? Hmailtar { get; set; }
    }
}

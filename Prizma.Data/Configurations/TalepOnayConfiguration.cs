...
{
    public class TalepOnayConfiguration : IEntityTypeConfiguration<TalepOnay>
    {
        public void Configure(EntityTypeBuilder<TalepOnay> builder)
        {
            builder.ToTable("talep_onay");

...
{
    public class v032TalepOnayConfiguration : IEntityTypeConfiguration<V032_TalepOnay>
    {
        public void Configure(EntityTypeBuilder<V032_TalepOnay> builder)
        {
            builder.HasNoKey().ToView("v032_talep_onay");
